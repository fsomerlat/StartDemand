	...
	class Pedido {
		...
		public function INSERT() {
			...
			$sql="INSERT INTO $this->table
					(cptuProduto_idProduto,cpQtdProduto,cpComplementoUm,cpComplementoDois,cpAcrescimo,cpQtdAcrescimo,cpValorAcrescimo,cpValorTotalPedido,cpStatusPedido,cpObservacaoPedido)
				  VALUES
					(:cptuProduto_idProduto,:cpQtdProduto,:cpComplementoUm,:cpComplementoDois,:cpAcrescimo,:cpQtdAcrescimo,:cpValorAcrescimo,:cpValorTotalPedido,:cpStatusPedido,:cpObservacaoPedido)";
			$in=DB::prepare($sql);
			...
			$in->bindParam(":cpValorAcrescimo", $this->cpValorAcrescimo,PDO::PARAM_STR);
